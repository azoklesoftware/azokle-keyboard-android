...
import com.azokle.keyboard.inputmethod.latin.common.UnicodeSurrogate;
import com.azokle.keyboard.inputmethod.latin.settings.SpacingAndPunctuations;
import com.azokle.keyboard.inputmethod.latin.utils.CapsModeUtils;
import com.azokle.keyboard.inputmethod.latin.utils.DebugLogUtils;
  ...
  public void commitText(final CharSequence text, final int newCursorPosition) {
    ...
    if (isConnected()) {
      ...
      for (final CharacterStyle span : spans) {
        ...
        // See com.azokle.keyboard.inputmethod.latin.common.Constants.UnicodeSurrogate
